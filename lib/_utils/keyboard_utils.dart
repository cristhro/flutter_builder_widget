import 'package:builder_widgets/_utils/device_info.dart';
...
class KeyboardUtils {
  ...
  static List<String> handleMultiSelectListClick({required String clicked, required List<String> selected, required List<String> all, required bool touchMode, bool allowSpanSelect = true}) {
  ...
  static List<String> _selectSpan({required String clicked, required List<String> selected, required List<String> all}) {
