...
class StyledToggleSwitch extends StatefulWidget {
  StyledToggleSwitch({Key? key, this.value = false, this.onToggled, required this.tooltip1, required this.tooltip2, this.icon1, this.icon2, this.materialIcon1, this.materialIcon2}) : super(key: key) {
              ...
              child: Container(
                ...
                child: AnimatedSwitcher(
                  ...
                  child: Container(
                    ...
                    child: (widget.value) ? _buildIcon(widget.icon2, widget.materialIcon2, color: theme.accent1) : _buildIcon(widget.icon1, widget.materialIcon1, color: theme.accent1),
                  ),
                ),
              ),
            ),
